...
class Products extends CI_Controller
{
	...
	public function create_product()
	{
		...
		$this->form_validation->set_rules('txtProdHt', 'Product height', 'required');
		$this->form_validation->set_rules('txtProdDimUom', 'Product dimension UOM', 'required'); 
		...
		$this->form_validation->set_rules('txtProdMfgTime', 'Manufacturing Time', 'required');
		$this->form_validation->set_rules('txtProdMfgTimeUom', 'Manufacturing Time UOM', 'required');
		...
		if($this->form_validation->run() == true)
		{
			...
			$prod_data['prod_dim_uom']    = $this->input->post('txtProdDimUom');
