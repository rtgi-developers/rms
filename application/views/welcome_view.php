...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="#home" class="w3-bar-item w3-button w3-wide">
      <img src="<?php echo base_url('assets/img/logo/rtgi_logo.png'); ?>" width="100" height="40" class="d-inline-block align-top" alt="Site logo">
    </a>
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home" style="background: #000000 !important;">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    <span class="w3-jumbo w3-hide-small">Start something that matters</span><br>
    <span class="w3-xxlarge w3-hide-large w3-hide-medium">Start something that matters</span><br>
    <span class="w3-large">Stop wasting valuable time with projects that just isn't you.</span>
    <p>
      <a href="<?php echo base_url('users/login'); ?>" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-hover-opacity-off" style="background: #2F74F6 !important; color: #ffffff !important;">Login to RMS</a>
    </p>
  </div> 
