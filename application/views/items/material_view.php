...
<div class="d-flex flex-row no-gutters mb-2">
	<div class="input-group pr-2 col-md-10">
	    ...
	    <input class="form-control form-control-sm py-2 border-left-0 border bg-whitesmoke table-tool-input" type="search" id="txtSearchMatl" placeholder="Search all materials">
	</div>
	<a href="<?php echo base_url('items/materials/view_create_matl'); ?>" id="lnkCreateMatl" class="btn btn-primary btn-sm btn-block text-nowrap border-gainsboro-2 col-md-2">
		<i class="las la-plus-circle la-lg"></i> Create Material
	</a>
</div>
